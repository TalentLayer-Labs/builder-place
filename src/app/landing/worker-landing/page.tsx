        ...
        <div className='container'>
          <div
            ...
            <p className='text-base text-body mt-5 mb-10'>
              BuilderPlace is currently in alpha. there are open-source missions live today for you
              to contribute to.
            </p>
          </div>
        </div>
          ...
          <div className='-mx-6 flex flex-wrap'>
              ...
              <div
                ...
                <div className='mb-5 border-b border-stroke'>
                  <p className='pb-9 text-base text-body'>
                    ...
                    just code; it's about working together for a common goal. I can share my skills
                    and time with others to create technology that helps people. It's not just about
                    my code, but all of us coming together to make the world better with technology.
                  </p>
                </div>
            ...
            <div className='w-full px-6 lg:w-1/2'>
              <div
                ...
                <div className='mb-5 border-b border-stroke'>
                  <p className='pb-9 text-base text-body'>
                    Open source contributions gave me a big boost in learning new skills quickly and
                    opened up many opportunities for remote work. It's like a superhighway for
            ...
            <div className='-mx-4 flex flex-wrap items-center justify-between'>
              <div className='w-full px-4 lg:w-1/2'>
                <div
                  ...
                  data-wow-delay='.2s'>
                  <img src='/images/search.png' alt='about image' className='mx-auto max-w-full' />
                </div>
              </div>
            ...
            <div className='-mx-4 flex flex-wrap items-center justify-between'>
              <div className='w-full px-4 lg:w-1/2'>
                <div
                  className='wow fadeInUp relative z-10 mx-auto mb-14 w-full max-w-[470px] pb-6 lg:mx-0 lg:mb-0'
                  data-wow-delay='.2s'>
                  <img src='/images/reviews.png' alt='about image' className='mx-auto max-w-full' />
                </div>
              </div>
